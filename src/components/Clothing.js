...
export default function Clothing() {
    const data = products.filter(product => product.category === "clothing");
    return (
        <div className="m-auto" >
            <h3 id="featured-head">LATEST CLOTHES <br /><img src="media/underline.png" height="20px" width="240px" />
            </h3>
            <div className="text-center">
                <ul>
                    <Link to="/home" className="inlinelist">ALL </Link>
                    <li className="inlinelist"> - </li>
                    <Link to="/clothing" className="active-elemen inlinelist">CLOTHING</Link>
                    <li className="inlinelist"> - </li>
