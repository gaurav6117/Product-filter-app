...
export default function Hats() {
    const data = products.filter(product => product.category === "hats");
    return (
        <div className="m-auto" style={{ width: "95%", backgroundColor: "" }}>
            <h3 id="featured-head">LATEST HATS <br /><img src="media/underline.png" height="20px" width="240px" />
            </h3>
            <div className="text-center">
                <ul>
                    ...
                    <li className="inlinelist"> - </li>
                    <Link to="/hats" className="active-elemen inlinelist">HATS</Link>
                    <li className="inlinelist"> - </li>
