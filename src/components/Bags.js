...
export default function Bags() {
    const data = products.filter(product => product.category === "bags");
    return (
        <div className="m-auto" style={{ width: "95%", backgroundColor: "rgb(248, 249, 250)" }}>
            <h3 id="featured-head">LATEST BAGS<br /><img src="media/underline.png" height="20px" width="240px" />
            </h3>
            <div className="text-center">
                <ul>
                    ...
                    <li className="inlinelist"> - </li>
                    <Link to="/bags" className="active-elemen inlinelist">BAGS</Link>
                    <li className="inlinelist"> - </li>
